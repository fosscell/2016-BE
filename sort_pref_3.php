...
<html>
	...
	<?php
			...
			if ($rslt->num_rows < 0) {
				...
				echo "<table><tr><th>Contributing to MediaWiki - Tony Thomas</th><th>Designing the next generation of maps using OpenStreetMap data - Ramya Ragupathy</th><th>The Design of Clojure - Shantanu</th><th>Consumer Rights and Digital Freedom - Panel Discussion</th><th>Introduction to non linear functions and fractals -Noufal Ibrahim</th><th>Getting Started with Contributing to Mozilla - Akshay S Dinesh</th><th>no pref</th></tr>";
