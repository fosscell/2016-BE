...
<html>
	...
	<?php
			...
			if ($rslt->num_rows < 0) {
				...
				echo "<table><tr><th>What is a Linux distribution? - Syam G Krishnan</th><th>Golang Workshop - Baiju Muthukadan</th><th>FPGA Hacking with Free Software tools - Pramode C.E</th><th>Computer Vision / Machine Learning Using Open Source Tools - Sumod Mohan</th><th>Evolution of FOSS (and some non-FOSS) stack at HackerRank - Abhimanyu</th><th>Y U No fixing WhatsApp? - Pirate Praveen</th><th>Intro to Debian Packaging - Balasankar C</th><th>MicroHOPE - Introduction to the world of Micro Controllers - Akshai M</th></tr>";
